...
Problems:
1. Text processing. (3rd thread). Currently, we are only add ONE space if spaces are larger than 1 from the array.
2. Thead1 finishes first. Then thread2. Then thread3. They are not working concurrently.
