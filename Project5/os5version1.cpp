...
int main () {
	...
	for ( int windowSize = 1; windowSize < 201; windowSize ++ ) {
		...
		cout << "Debugging statement: Reference String Length is: " << referenceStringLength << endl; //referenceStringLength = 1302;
		...
		// cout << "this is window size of:  " << windowSize << endl;
		...
		// cout << "at windowSize of: " << windowSize << ", total page fault is: " << totalPageFault << endl;
		...
		// end of generating statistics page;
