...
void generateStatistics(int referenceStringLengthFn, string referenceStringFn, int workingSetArraySizeFn[]);
...
int main () {
   ...
   for ( int windowSize = 1; windowSize < 201; windowSize++ ) {
      ...
      // initialize pageFaultCounter
      for (int i = 0; i < referenceStringLength; i++ ) {
         pageFaultStatus[i] = 0;
      }
      generateStatistics(windowSize, referenceStringLength, referenceString, workingSetArraySize);
      printStatistics(windowSize, referenceStringLength, pageFaultStatus, workingSetArraySize);
   }
...
void generateStatistics(int windowSizeFn, int referenceStringLengthFn, string referenceStringFn) {
