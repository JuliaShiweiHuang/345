...
int main()
{
   ...
   cout << "after joining" << message1 << endl;
...
void* print_message_function( void *ptr )
{
   ...
   cout <<"This part should print out message" << message << endl;
   cout << "this should print obtain ID of the calling thread" << pthread_self () << endl;
